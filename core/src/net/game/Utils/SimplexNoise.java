...
public class SimplexNoise {
    ...
    public double getSingleNoise(int x, int y, int z){
        double result = 0;
        SimplexOctave myoctave = new SimplexOctave(0);
    ...
    public double getDoubleNoise(int x, int y, int z){
        double result = 0;
        SimplexOctave myoctave = new SimplexOctave(0);
        SimplexOctave myoctave2 = new SimplexOctave(1);
        result = (myoctave.noise(x,y,z) +
    ...
    public double getQuadNoise(int x, int y, int z){
        double result = 0;
        SimplexOctave myoctave = new SimplexOctave(0);
        SimplexOctave myoctave2 = new SimplexOctave(10);
        SimplexOctave myoctave3 = new SimplexOctave(20);
        SimplexOctave myoctave4 = new SimplexOctave(40);
        result = (myoctave.noise(x,y,z) +
                (myoctave2.noise(x,y,z) /2) +
    ...
    public double getOctNoise(int x, int y, int z){
        ...
        SimplexOctave myoctave3 = new SimplexOctave(20);
        SimplexOctave myoctave4 = new SimplexOctave(40);
        SimplexOctave myoctave5 = new SimplexOctave(80);
        SimplexOctave myoctave6 = new SimplexOctave(100);
        SimplexOctave myoctave7 = new SimplexOctave(120);
        SimplexOctave myoctave8 = new SimplexOctave(140);
        result = (myoctave.noise(x,y,z) +
                (myoctave2.noise(x,y,z) /2) +
                (myoctave3.noise(x,y,z) /4) +
                (myoctave4.noise(x,y,z) /8) +
